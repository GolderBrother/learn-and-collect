...
export function getResources(){
    return request('/role/getResource');
}
export function setRoleResources(values) {
    return request(`/role/setResource`,{
        method:'POST',
        headers:{
            "Content-Type":"application/json"
        },
...
export function getUsers(){
    return request('/role/getUser');
}
export function setRoleUsers(values) {
    return request(`/role/setUser`,{
        method:'POST',
        headers:{
            "Content-Type":"application/json"
        },
